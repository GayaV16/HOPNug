...
def test_valid_inputs(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase1.png"
...
def test_invalid_name(driver,fill_and_submit_form):
    fill_and_submit_form(vendor="Test$%^^", amount="50", date="14/06/2025", status="Paid")
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase2.png"
    driver.save_screenshot(path)
...
def test_blank_name(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase3.png"
    driver.save_screenshot(path)
...
def test_negative_amount(driver,fill_and_submit_form):
    fill_and_submit_form(vendor="Test",amount="-50",date="14/06/2025",status="Paid")
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase4.png"
    driver.save_screenshot(path)
...
def test_blank_amount(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase5.png"
    driver.save_screenshot(path)
    message = driver.find_element(By.ID, "amount-error").text
    print(message)
...
def test_valid_pastdate(driver,fill_and_submit_form):
    fill_and_submit_form(vendor="Test", amount="50", date="14/06/2025", status="Paid")
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase6.png"
    driver.save_screenshot(path)
    message = driver.find_element(By.ID, "success-box").text
    print(message)
    assert "Form submitted successfully!" in message
...
def test_invalid_futuredate(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase7.png"
    driver.save_screenshot(path)
...
def test_invalid_dateformat(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase8.png"
    driver.save_screenshot(path)
    message = driver.find_element(By.ID, "date-error").text
    print(message)
...
def test_blank_date(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase9.png"
    driver.save_screenshot(path)
    message = driver.find_element(By.ID, "date-error").text
    print(message)
...
def test_valid_status(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase10.png"
    driver.save_screenshot(path)
    message = driver.find_element(By.ID, "success-box").text
    print(message)
    assert "Form submitted successfully!" in message
...
def test_all_fields_empty(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase11.png"
    driver.save_screenshot(path)
...
def test_invalid_name_sql_injection(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase12.png"
    driver.save_screenshot(path)
    message = driver.find_element(By.CLASS_NAME, "error").text
    print(message)
    assert "Vendor name must use letters and spaces only." in message
...
def test_nonnumeric_amount(driver,fill_and_submit_form):
    ...
    path = "C:\\Users\\Paras\\PycharmProjects\\pythonProject\\HOPN ug\\Form_testcases_screenshots\\form_testcase13.png"
    driver.save_screenshot(path)
    message = driver.find_element(By.ID,"amount-error").text
    print(message)
    assert "Amount must be a positive number greater than 0." in message
